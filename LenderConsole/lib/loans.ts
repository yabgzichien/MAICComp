...
export const MIN_CONFIDENCE_TO_APPROVE = 0.7;
...
//   1. It sits BELOW the integrity rings' hard cap of 0.39 (the borrower app's Trust Dampener),
//      which is pinned there precisely so an asymmetric-fraud catch lands in REFER and gets a
//      human. Putting this floor at or above 0.39 would silently convert every one of those
//      catches into an automatic rejection — the opposite of what that layer is for.
...
export const MIN_CONFIDENCE_TO_CONSIDER = 0.35;
