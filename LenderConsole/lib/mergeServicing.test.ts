...
// 2026-07-18 design). Byte-identical behaviour is expected from PipComp/src/lib/servicing.ts
// — this file is the canonical spec both ports are tested against.
import { describe, expect, it } from 'vitest';
import { emptyServicingRecord, mergeServicing, type ServicingRecord } from './mergeServicing';
...
describe('mergeServicing', () => {
  ...
  it('on a same-instalment conflict, the later `at` wins — a correction supersedes', () => {
    ...
    // order-independent: swapping which side is passed first doesn't change the winner
