// lib/securitization.ts
// Ported verbatim from PipComp/src/lib/securitization.ts (the loans.ts/passport.ts
// port-pair convention) so the console structures pools with the SAME engine the
